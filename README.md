...
- [x] **Web Search Integration** — Chatbot responses include current, real-world information with visible links or citations (Wikipedia API, no key required)
- [x] **RTL Language Support** — Layout supports right-to-left languages; product grid, selected products section, and chat all adjust correctly (toggle button in header)
...
| LevelUp: Web Search | ✅ Done |
| LevelUp: RTL Language Support | ✅ Done |
